...
# ---------------------------------------------------
# 2. MOTOR DE FIRMAS WOMPI (LIMPIEZA TOTAL)
# ---------------------------------------------------
def generar_firma_wompi(referencia, monto, moneda):
    """
    Crea el hash SHA256 exacto limpiando cualquier espacio o decimal.
    """
    if not WOMPI_SECRET:
        return None
...
# ---------------------------------------------------
# 4. RUTAS DE ADMINISTRACIÓN Y PRODUCTOS
# ---------------------------------------------------
...
# ---------------------------------------------------
# 5. RUTAS ESTÁTICAS Y ARCHIVOS (AL FINAL)
# ---------------------------------------------------
